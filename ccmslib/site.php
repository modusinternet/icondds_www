...
function csp_header() {
	...
	$buffer = "Content-Security-Policy: ".
		...
		"script-src 'nonce-" . $CFG["nonce"] . "' 'strict-dynamic' 'unsafe-eval' *.googletagmanager.com *.google-analytics.com; ".
		...
		"style-src 'self' 'nonce-" . $CFG["nonce"] . "' *.googletagmanager.com *.google-analytics.com; ";
